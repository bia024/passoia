...
const produtosNovidades = [
  { id: 1, imagem: prod1, nome: "Batons (Preço unitário)", preco: 79.9 },
  { id: 2, imagem: prod2, nome: "Batom Líquido (Preço unitário)", preco: 49.9 },
  { id: 3, imagem: prod3, nome: "Gloss (Preço unitário)", preco: 99.9 },
