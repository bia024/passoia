...
//as fotos são essas
// import thumb1 from '../../assets/azul.png';
// import thumb2 from '../../assets/rosa.png';
// import thumb3 from '../../assets/vermelho.png';
      ...
      <article className="lancamentos-grid">
        ...
        <aside className="details">
          ...
          <section className="descricao">
            <h4>Descrição</h4>
            {/* transformar esse p em "" para puxar as apis devidas a cada descrição dos produtos. em seguida, chamar mais produtos */}
            <p>
