        ...
        <div className="contatos-grid">
          ...
          <section className="contatos-col" aria-labelledby="redes">
            ...
            <div className="socials">
              <a href="#" aria-label="Instagram" className="social-btn"><img src={ig} alt="Instagram"/></a>
              <a href="#" aria-label="Facebook" className="social-btn"><img src={fb} alt="Facebook"/></a>
              <a href="#" aria-label="YouTube" className="social-btn"><img src={yt} alt="YouTube"/></a>
              <a href="#" aria-label="Twitter" className="social-btn"><img src={tw} alt="Twitter"/></a>
            </div>
          </section>
        </div>
      </div>
